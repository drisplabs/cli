...
`wontfix` already exists on `drisplabs/cli`. The other four labels are created on first use:
...
gh label create ready-for-agent --repo drisplabs/cli --color 0E8A16 --description "Fully specified, AFK-agent-ready"
