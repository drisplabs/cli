...
| **Message** (sub-Turn)                           | _message_ — user/assistant/tool_use/tool_result; + _model request_               | _item_ — agent message, reasoning, command exec, tool call, …                                                          | Formally defined by both                                                          |
